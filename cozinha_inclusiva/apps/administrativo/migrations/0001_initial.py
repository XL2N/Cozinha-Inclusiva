    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('ADMIN', 'Administrador'), ('LEITOR', 'Leitor'), ('AUTOR', 'Autor')], default='LEITOR', max_length=10, verbose_name='Tipo')),
                ('imagem', models.ImageField(blank=True, null=True, upload_to='usuarios/fotos/', verbose_name='Imagem')),
